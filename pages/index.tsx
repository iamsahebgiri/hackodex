  ...
  return (
    <Layout>
      <motion.div
        ...
        variants={variants}
      >
        <motion.div className="mx-auto max-w-2xl py-32" variants={variants}>
          <motion.div className="text-center" variants={variants}>
              ...
              <div className="mx-auto max-w-2xl">
                <div className="text-center">
                  ...
                  <p className="mt-6 text-lg leading-8 text-[#e3c598]">
                    ...
                    We&apos;ve curated a list of beginner friendly issues for
                    you to check out.
                  </p>
            ...
            <div className="mt-36">
              <h1 className="mb-9 text-xl text-[#e3c598]">In Collaboration with</h1>
              <Sponsor />
            </div>
          </motion.div>
        </motion.div>
