...
export default function UserDropdown() {
  ...
  return (
    ...
    >
      <Popover
        content={
          <div className="w-full rounded-md bg-white p-2 sm:w-56 text-[#6e352c]">
            <Link
      ...
      >
        <button
          ...
          className="flex h-10 w-10 mt-1 items-center justify-center overflow-hidden rounded-full border border-gray-300 transition-all duration-75 focus:outline-none active:scale-95 sm:h-9 sm:w-9"
        >
          <Image
            alt={email}
